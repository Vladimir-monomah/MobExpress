                ...
                <div class="panel panel-colorful panel-dark">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <p style="font-size: 25px"><b><?=currency('','def').' '.$this->cart->format_number($value->amount)?>
                            </b></p>
                            <p><?=translate('product_upload')?>: <?=$value->upload_amount?> times</p>
                            
                        </div>
                        <div class="col-sm-12">
                            <a id="demo-dt-view-btn" class="btn btn-mint add-tooltip" onclick="ajax_set_full('edit', 
                            '<?php echo translate('Редактировать пакет'); ?>', '<?php echo translate('Успешно отредактирован!'); ?>', 
                            'package_uploader_edit', '<?=$value->package_id?>', proceed('to_edit'))" style="width: 100%" >
                ...
                <div class="panel panel-bordered-primary">
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <p><?=translate('Загрузка продукта')?>: <?=$value->upload_amount?> <?=translate('Время')?></p>
                            
                        </div>
                        <div class="col-sm-12">
                            <a id="demo-dt-view-btn" class="btn btn-primary add-tooltip" onclick="ajax_set_full('edit', 
                            '<?php echo translate('Редактировать пакет'); ?>', '<?php echo translate('Успешно отредактирован!'); ?>', 
                            'package_uploader_edit', '<?=$value->package_id?>', proceed('to_edit'))" style="width: 100%" >
                            <i class="fa fa-edit"></i> Редактировать</a>
                        </div>
