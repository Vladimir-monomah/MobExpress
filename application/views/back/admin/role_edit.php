		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea name="description" class="form-control required" placeholder="<?php echo translate('Описание'); ?>" ><?php echo $row['description']; ?></textarea>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    data-id='<?php echo $row1['permission_id']; ?>' <?php if(in_array($row1['permission_id'],
                                    $permission)){ echo 'checked';} ?> />
                                </td>
                            </tr>
                            <?php
                                    }
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right" 
                            onclick="form_submit('role_edit','<?php echo translate('Успешно отредактирован!'); ?>')" >
