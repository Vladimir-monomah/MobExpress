    ...
    ?>
        <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('payment_status'); ?></label>
                        ...
                        ?>
                            <?php
                                $from = array('due','paid');
                                echo $this->crud_model->select_html($from,'vendor_payment_status','','edit','demo-chosen-select',
                                $status);
                            ?>	
                        <?php
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea name="payment_details" class="form-control" 
                    <?php if($method == 'paypal' || $method == 'stripe'){ ?>readonly<?php } ?> rows="10">
                    <?php echo $payment_details; ?></textarea>
                </div>
            </div>
            <?php
            	}
