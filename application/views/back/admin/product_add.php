                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Название продукта');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border" id="sub" style="display:none;">
                                <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('Подкатегория');?></label>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <h4 class="pull-left">
                                        <i>
                                        <?php echo translate
                                        ('Eсли вам нужно больше поля для вашего продукта, нажмите здесь, чтобы узнать больше ...');?></i>
                                    </h4>
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <?php echo translate('Цена продажи');?></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    placeholder="<?php echo translate('Скидка на товар');?>" class="form-control">
                                </div>
                                <div class="col-sm-1">
...
<script>
    ...
    $("#more_btn").click(function(){
        $("#more_additional_fields").append(''
            ...
            +'    <div class="col-sm-4">'
            +'        <input type="text" name="ad_field_names[]" class="form-control required"  placeholder="<?php echo translate('Название поля'); ?>">'
            +'    </div>'
            +'    <div class="col-sm-5">'
