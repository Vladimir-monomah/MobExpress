<div id="content-container"> 
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Управлять настройками бизнеса');?></h1>
    </div>
    <div class="tab-base">
                ...
                ?>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <?php echo translate('Оплата наличными');?></label>
                            <div class="col-sm-6">
                                <div class="col-sm-">
                                    <input id="cash_set" class='sw7' data-set='cash_set' type="checkbox" 
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="demo-hor-inputemail">
                            <?php echo translate('Оплата через PayPal');?></label>
                            <div class="col-sm-6">
                                <div class="col-sm-">
                                    <input id="paypal_set" class='sw8' data-set='paypal_set' type="checkbox" 
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('Электронная почта PayPal');?></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="demo-hor-inputemail">
                                <?php echo translate('Тип счета PayPal');?>
                                    </label>
                            <div class="col-sm-6">
                                <?php
                                    $from = array('sandbox','original');
                                    echo $this->crud_model->select_html($from,'paypal_type','','edit',
                                    'demo-chosen-select',$paypal_type);
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="demo-hor-inputemail">
                            <?php echo translate('Полоса оплаты');?></label>
                            <div class="col-sm-6">
                                <div class="col-sm-">
                                    <input id="stripe_set" class='sw7' data-set='stripe_set' type="checkbox" 
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('Название валюты');?></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('Символ валюты');?></label>
                            <div class="col-sm-6">
                        ...
                        <!--<div class="form-group">
                            <label class="col-sm-3 control-label">1 Рубль (Р) = </label>
                            <div class="col-sm-3">
                                <input type="number" name="exchange" value="<?php echo $exchange; ?>"  
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" ><?php echo translate('Стоимость доставки (если зафиксировано)');?> 
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('FAQ');?></label>
                        ...
                        ?> 
                            <div class="form-group btm_border">
                                <div class="col-sm-4">
                                    <input type="text" name="f_q[]" value="<?php echo $row1['question']; ?>
                                    " placeholder="<?php echo translate('Вопрос'); ?>" class="form-control" >
                                </div>
                                <div class="col-sm-5">
                                      <textarea name="f_a[]" class="form-control"  
                                      placeholder="<?php echo translate('Ответ'); ?>"><?php echo $row1['answer']; ?></textarea>
                                </div>
                                <div class="col-sm-2">
                        ...
                        <div class="form-group btm_border">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <?php echo translate('добавить больше FAQ');?></div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $("#more_btn").click(function(){
        $("#more_additional_fields").append(''
            ...
            +'    </div>'
            +'    <div class="col-sm-5">'
            +'          <textarea name="f_a[]" class="form-control"  placeholder="<?php echo translate('Ответ'); ?>"></textarea>'
            +'    </div>'
            +'    <div class="col-sm-2">'
