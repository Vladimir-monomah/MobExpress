...
<div class="panel-body" id="demo_s">
    <table id="events-table" class="table table-striped"  data-url="<?php echo base_url(); ?>admin/product/list_data"
        ...
        <thead>
            <tr>
                ...
                <th data-field="added_by" data-sortable="true">
                    <?php echo translate('Добавлено');?>
                </th>
                 <?php endif ?>
                <th data-field="current_stock" data-sortable="true">
                    <?php echo translate('Текущее количество');?>
                </th>
                <th data-field="deal" data-sortable="false">
                    <?php echo translate("Сегодняшняя сделака");?>
                </th>
