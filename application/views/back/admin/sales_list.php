     ...
     data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <thead>
            <tr>
                ...
                <th><?php echo translate('Код продажи');?></th>
                <th><?php echo translate('Покупатель');?></th>
                <th><?php echo translate('Дата');?></th>
                <th><?php echo translate('Сумма');?></th>
                <th><?php echo translate('Статус доставки');?></th>
                <th><?php echo translate('Статус платежа');?></th>
        ...
        <tr class="<?php if($row['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td><?php if($row['buyer'] == 'guest'){ echo '<b class="text-info">Guest</b>';} 
            else{echo $this->db->get_where('user', array('user_id' => $row['buyer']))->row()->username;} ?></td>
              ...
              ?>
                ...
                <?php
                        if(isset($dev['vendor'])){
                            ...
                            ('.translate('Поставщик').') : '.$dev['status'];
                        } else if(isset($dev['admin'])) {
                            echo translate('Админ').' : '.$dev['status'];
                        }
                ?>
                </div>
                <br>
            ...
            <td class="text-right">
                ...
                <a class="btn btn-info btn-xs btn-labeled fa fa-file-text" data-toggle="tooltip"
                    onclick="ajax_set_full('view','<?php echo translate('Заголовок'); ?>',
                    '<?php echo translate('Успешно отредактирован!'); ?>','sales_view','<?php echo $row['sale_id']; ?>')"
                        data-original-title="Edit" data-container="body"><?php echo translate('Полный счёт'); ?>
                </a>

                <a class="btn btn-success btn-xs btn-labeled fa fa-usd" data-toggle="tooltip"
                    onclick="ajax_modal('delivery_payment','<?php echo translate('Оплата доставки'); ?>',
                    '<?php echo translate('successfully_edited!'); ?>','delivery_payment','<?php echo $row['sale_id']; ?>')"
                        data-original-title="Edit" data-container="body">
                            <?php echo translate('Статус доставки'); ?>
                </a>

                <a onclick="delete_confirm('<?php echo $row['sale_id']; ?>',
