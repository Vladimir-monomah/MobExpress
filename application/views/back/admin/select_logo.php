<div class="panel-heading">
    <h3 class="panel-title"><?php echo translate('Выбрать');?> <?php echo translate($logo_type); ?></h3>
</div>
<?php
...
<div class="panel-body">
    ...
    <?php foreach ($logo as $row){ ?>
        <div class="delete-div-wrap cc-selector">
            <input id="log_<?php echo $row['logo_id']; ?>" type="radio" value="<?php echo $row['logo_id']; ?>" 
			name="logo_id" <?php if($row['logo_id'] == $now){ echo 'checked'; } ?> >
