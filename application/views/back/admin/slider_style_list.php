                ...
                <div class="panel-body">
                    <div class="style_layer" style="width:100%;height:500px;">
                        <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                            <img src="<?php echo base_url(); ?>uploads/slider_image/styles/
                            <?php echo $row['slider_style_id']; ?>.jpg" class="ls-bg" />
                        </div>
                    </div>
                    <div class="back_layer" style="display:none;">
                        <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                            <img src="<?php echo base_url(); ?>uploads/slider_image/defaults/
                            <?php echo $style['background']; ?>.jpg" class="ls-bg" /> 
                            <?php foreach($style['images'] as $image){ ?>
                                <img class="ls-l" src="<?php echo base_url(); ?>uploads/slider_image/defaults/
                                <?php echo $image['name']; ?>.png" style="<?php echo $image['style']; ?>" 
                                data-ls="<?php echo $image['data_ls']; ?>" >
                            <?php } ?>
                            <?php foreach($style['texts'] as $text){ ?>
                                <<?php echo $text['element']; ?> class="ls-l"  style="<?php echo $text['style']; ?> 
                                color:<?php echo $text['color']; ?>; background:<?php echo $text['background']; ?>;" 
                                data-ls="<?php echo $text['data_ls']; ?>" >
