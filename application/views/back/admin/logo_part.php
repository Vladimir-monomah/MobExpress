<div class="col-md-12 col-sm-12">
    <div class="panel">
        ...
        <h3 class="panel-title"><?php echo translate('Обновить логотип');?></h3>
    </div>
		<?php
                ...
                <div class="form-group margin-top-10">
                    <div class="col-sm-12">
                        <div class="col-sm-6 col-sm-offset-3">
                            <center>
                                <img class="img-responsive img-md img-border" style="width:50%;height:40%" 
                                src="<?php echo base_url(); ?>uploads/others/photo_default.png" id="blah5" >
                            
                            <br />
                            <span class="btn btn-default btn-file margin-top-10">
                                <?php echo translate('Выбрать логотип');?>
...
<div class="panel">
<div class="panel-heading">
    <h3 class="panel-title"><?php echo translate('Все логотипы');?></h3>
</div>
...
<div class="panel-body">
    <table class="table">
        <thead>
            <tr>
                <th><?php echo translate('Место');?></th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="inner-div tr-bg img-fixed">
                        ...
                        uploads/logo_image/logo_<?php echo $admin_login_logo; ?>.png" id="admin_login_logo">
                    </div>
                </td>
                <td class="text-right">
                    <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                        onclick="ajax_modal('show_all/selectable','<?php echo translate('Выбрать логотип'); ?>',
                        '<?php echo translate('Успешно выбран!'); ?>','logo_set_change','admin_login_logo')">
                            <?php echo translate('Изменить');?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inner-div tr-bg img-fixed">
                        <img class="img-responsive img-sm" src="<?php echo base_url(); ?>
                        uploads/logo_image/logo_<?php echo $home_top_logo; ?>.png" id="home_top_logo" >
                    </div>
                </td>
                <td class="text-right">
                    <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                        onclick="ajax_modal('show_all/selectable','<?php echo translate('Выбрать логотип'); ?>',
                        '<?php echo translate('Успешно выбран!'); ?>','logo_set_change','home_top_logo')">
                            <?php echo translate('Изменить');?>
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="inner-div tr-bg img-fixed">
                        <img class="img-responsive img-sm" src="<?php echo base_url(); ?>
                        uploads/logo_image/logo_<?php echo $home_bottom_logo; ?>.png" id="home_bottom_logo" alt="User_Image" >
                    </div>
                </td>
                <td class="text-right">
                    <span class="btn btn-info btn-labeled fa fa-plus-circle" 
                        onclick="ajax_modal('show_all/selectable','<?php echo translate('Выбрать логотип'); ?>',
                        '<?php echo translate('Успешно выбран!'); ?>','logo_set_change','home_bottom_logo')">
                            <?php echo translate('Изменить');?>
                    </span>
                </td>
            </tr>
