                    ...
                    <div class="tab-content">
                    	<div id="bundle_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('Детали пакета'); ?></h4>                            
                            </div>
                ...
                <div class="row">
                	<div class="col-md-11">
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right " 
                            onclick="ajax_set_full('add','<?php echo translate('add_product_bundle'); ?>',
                            '<?php echo translate('Успешно добавлен!'); ?>','product_bundle_add',''); ">
                    ...
                    <div class="col-md-1">
                        ...
                        onclick="form_submit('product_bundle_add','<?php echo translate('Комплект продукта загружен!'); ?>');
...
<script>
    ...
    $("#more_btn").click(function(){
        ...
        $("#more_additional_fields").append(''
            ...
            +'        <label class="col-sm-5 control-label" for=""><?php echo translate('Продукт');?></label>'
