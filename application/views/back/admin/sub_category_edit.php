    ...
    ?>
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="sub_category_name" value="<?php echo $row['sub_category_name'];?>" 
                    class="form-control required" placeholder="<?php echo translate('Название подкатегории'); ?>" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('Баненр подкатегории');?></label>
                <div class="col-sm-6">
                    ...
                    <span id='wrap' class="pull-left" >
						...
						?>
						<img src="<?php echo base_url(); ?>uploads/sub_category_image/
                        <?php echo $row['banner']; ?>" width="100%" id='blah' />  
						<?php
							} else {
						?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    select_html('category','category','category_name','edit','demo-chosen-select required',$row['category'],
                    'digital',NULL); ?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label"><?php echo translate('Бренды');?></label>
                <div class="col-sm-6">
                    <?php
            ...
            get_settings_value('general_settings', 'product_affiliation_set', 'value') != 'ok') { ?> style="display: none" <?php } ?>>
                <label class="col-sm-4 control-label" for="demo-hor-1">
                    <?php echo translate('Принадлежность');?>
                </label>
                <div class="col-sm-6 pt-5">
                    <input type="checkbox" name="affiliation" <?= $row['affiliation'] == 1 ? " checked='checked' ":"" ?> 
                    class="form-control required  affiliation-check">
                </div>
            </div>
            <div class="form-group" <?php if($this->crud_model->
            get_settings_value('general_settings', 'product_affiliation_set', 'value') != 'ok') { ?> style="display: none" <?php } ?>>
                ...
                <div class="col-sm-6 control-label">
                    <input type="number" min="0.0" step="0.5"  name="affiliation_points" value="<?= $row['affiliation_points'] ?>" 
