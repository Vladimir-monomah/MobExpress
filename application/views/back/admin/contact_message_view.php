            ...
            <div class="text-center pad-all">
                <div class="col-md-12"> 
                    <table class="table table-striped" style="border-radius:3px;">
                        ...
                        <tr>
                            <th class="custom_td"><?php echo translate('Сообщение');?></th>
                            <td class="custom_td">
                                <?php echo $row['message']?>
                            </td>
                        </tr>
                        <tr>
                            <th class="custom_td"><?php echo translate('Дата/Время');?></th>
                            <td class="custom_td">
                        ...
                        <?php if($row['reply'] != ''){ ?>
                        <tr>
                            <th class="custom_td"><?php echo translate('Ответить');?></th>
                            <td class="custom_td">
                                <?php echo $row['reply']; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="custom_td">
                                <a class="btn btn-success btn-xs btn-labeled fa fa-reply" data-toggle="tooltip"
                                    onclick="ajax_set_full('reply_form','<?php echo translate('Ответ на контактное сообщение'); ?>',
                                    '<?php echo translate('Успешно применено!'); ?>','contact_message_reply',
