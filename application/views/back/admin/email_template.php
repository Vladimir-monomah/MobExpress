<div id="content-container"> 
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Управлять шаблонами писем'); ?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="tab-base tab-stacked-left">
				...
				?>
                    <li class="template_tab <?php if($i==1){ ?>active<?php } ?>">
                        <a data-toggle="tab" href="#demo-stk-lft-tab-<?php echo $row1['email_template_id']; ?>">
                        <?php echo translate($row1['title']);?></a>
                    </li>
                <?php
					}
				?>
                ...
                <?php
                	...
                	foreach($table_info as $row2){
						$j++;
				?>	
                    <div id="demo-stk-lft-tab-<?php echo $row2['email_template_id']; ?>" class="tab-pane fade 
                    <?php if($j==1){ ?>active in<?php } ?>">
                        <div class="panel">
                            ...
                            ?>
                                <div class="panel-body">
                                	<div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo translate('Продукт');?></label>
                                        <div class="col-sm-6">
                                            <input type="text" name="subject" value="<?php echo $row2['subject']; ?>"  
                                            class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo translate('Тело письма');?></label>
                                        <div class="col-sm-6">
                                            <textarea class="summernotes" data-height='300' data-name='body' >
                                            <?php echo $row2['body']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="panel-footer text-right">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter"  data-ing='
...
<div class="panel">
    ...
    ?>
                ...
                ?>
                    <div class="col-sm-3 box_area">
                        <div class="cc-selector">
                            <input type="radio" id="<?php echo $value; ?>" value="<?php echo $value; ?>" 
                            name="email_theme" <?php if($email_theme == $value){ echo 'checked'; } ?> >
                            <label class="drinkcard-cc" style="margin-bottom:0px; width:100%;" for="<?php echo $value; ?>">
                                <div class="col-sm-12">
                                    <div class="img_show">
                                        <img src="<?php echo base_url() ?>uploads/email_themes/<?php echo $value.'.jpg' ?>" 
                                        width="100%" style=" text-align-last:center;" alt="<?php echo $row; ?>" />
                                    </div>
                                </div>
                            </label>
                        </div>
        ...
        <div class="panel-footer text-right">
            ...
            ' data-msg='<?php echo translate('Обновить!'); ?>' onClick="check_style()">
                <?php echo translate('Обновить');?>
            </span>
        </div>       
    </form>
