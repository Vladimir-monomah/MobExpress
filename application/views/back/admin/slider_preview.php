<head>
	...
	<script src="<?php echo base_url(); ?>template/front/layerslider/js/layerslider.kreaturamedia.jquery.js" 
...
<body class="nobg">
	...
	function load_set(){
		...
		$('.otherimg').each(function(){
			...
			var itop = now.find('')
			$(".ls-slide").append(''
				+'	<img class="ls-l" style="top:'+itop+'px;left:'+ileft+'%; width: '+
				iwidth+'px; white-space: nowrap;" data-ls="delayin:'+idin+';durationin:'+iduin+';durationout:'+
				idout+';showuntil:'+iswuntl+';"
						 src="'+omg+'" alt="">'
			);
		});
