        ...
        <div class="text-center pad-all">
            <div class="col-md-3">
                <div class="col-md-12">
                    <img class="img-responsive thumbnail" alt="Profile Picture" 
                        src="<?php echo $this->crud_model->file_view('product',$row['product_id'],'','',
                        'thumb','src','multi','one'); ?>">
                </div>
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('Подкатегории');?></th>
                        <td class="custom_td">
                    ...
                    <tr>
                        ...
                        <td class="custom_td">
                            ...
                            <?php if($row['discount_type'] == 'percent'){ echo '%'; } elseif($row['discount_type'] == 
                            'amount'){ echo currency('','def'); } ?>
                        </td>
                    </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td class="custom_td">
                            <?php echo $row['tax']; ?>
                            <?php if($row['tax_type'] == 'percent'){ echo '%'; } elseif($row['tax_type'] == 
                            'amount'){ echo currency('','def'); } ?>
                        </td>
                    </tr>
                    <tr>
					...
					?>
                    <tr>
                        <th class="custom_td"><?php echo translate('Видео');?></th>
                        <td class="custom_td">
							<?php 
					...
					?>
                    <tr>
                        <th class="custom_td"><?php echo translate('Требования');?></th>
