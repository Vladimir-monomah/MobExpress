<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate
		('Управлять продуктом (цифровой)');?></h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            ...
                            <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
								...
								<?php echo translate('Вернуться к списку продуктов');?>
                            </button>
                        </div>
                    <!-- LIST -->
                ...
                success: function(data) {
					if(data == 'yes'){
						...
						$.activeitNoty({
							type: 'danger',
							icon : 'fa fa-times',
							message : '<?php echo translate('Ошибка загрузки!'); ?>',
							container : 'floating',
							timer : 3000
						});
					}
