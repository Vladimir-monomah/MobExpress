		...
		data-show-toggle="true" data-show-columns="true" data-search="true" >
			<thead>
				<tr>
					...
					<th><?php echo translate('Название продукта');?></th>
					<th><?php echo translate('Тип записи');?></th>
					<th><?php echo translate('Количество');?></th>
					<th><?php echo translate('Примечение');?></th>
			...
			<tr>
				...
				<td class="text-right">
					<?php
						if($row['type'] == 'add'){
					?>
						<a onclick="delete_confirm('<?php echo $row['stock_id']; ?>',
						'<?php echo translate('Добавленное количество будет уменьшено.'); ?> 
						<?php echo translate('Действительно хотите это удалить?'); ?>')" 
	                    	class="btn btn-xs btn-danger btn-labeled fa fa-trash" 
					...
					?>
						<a onclick="delete_confirm('<?php echo $row['stock_id']; ?>',
						'<?php echo translate('Уменьшенное количество будет добавлено.'); ?> 
						<?php echo translate('действительно хотите это удалить?'); ?>')" 
	                    	class="btn btn-xs btn-danger btn-labeled fa fa-trash" 
							data-toggle="tooltip" data-original-title="Delete" 
	                        	data-container="body"><?php echo translate('Удалить');?>
		...
		data-width='1500' style="display:none;">
				...
				<thead>
					<tr>
                        ...
                        <th><?php echo translate('Тип записи');?></th>
                        <th><?php echo translate('Количество');?></th>
                        <th><?php echo translate('Примечание');?></th>
					</tr>
				</thead>
