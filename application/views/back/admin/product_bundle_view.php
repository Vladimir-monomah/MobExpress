        ...
        <div class="text-center pad-all">
            ...
            <div class="col-md-9">   
                <table class="table table-striped" style="border-radius:3px;">
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('Продукт');?></th>
                        <td class="custom_td">
                            <?php
                                $products = json_decode($row['products'],true);
                                $num = count($products);
                            foreach ($products as $product) {
                                echo "&#9830; ".$this->crud_model->get_type_name_by_id
                                ('product',$product['product_id'],'title') ?><br>
                            <?php
                            }
                            ?>            
                        </td>
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('Единица измерения');?></th>
                    ...
                    <tr>
                        ...
                        <td class="custom_td">
                            ...
                            <?php if($row['discount_type'] == 'percent'){ echo '%'; } 
                            elseif($row['discount_type'] == 'amount'){ echo '$'; } ?>
                            / <?php echo $row['unit']; ?>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        <th class="custom_td"><?php echo translate('Теги');?></th>
                        <td class="custom_td">
