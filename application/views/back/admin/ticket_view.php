...
?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="text-center pad-all">
                <div class="col-md-12"> 
                    <table class="table table-striped" style="border-radius:3px;">
                        ...
                        <tr>
                            <th class="custom_td"><?php echo translate('Предмет');?></th>
                            <td class="custom_td">
                        ...
                        <tr>
                            <th class="custom_td"><?php echo translate('Дата и время');?></th>
                            <td class="custom_td">
            ...
            ?>
              <div class="col-md-12" >
                  <div class="col-md-12 btn btn-md btn-default overer" data-toggle="collapse" 
                  data-target="#demo<?php echo $row1['ticket_message_id']; ?>" 
                  style="cursor:pointer; background-color: #F5F5F5; border-color: #D8D8D8; margin-top: 5px;">
                  	<div class="col-md-1 text-left">
                        <div class="row" style="padding:5px;">
                            ...
                            <?php } else if($this->db->get_where('user',array('user_id'=>$from1['id']))->row()->fb_id !== ''){ ?>
                                src="https://graph.facebook.com/<?php echo $this->db->
                                get_where('user',array('user_id'=>$from1['id']))->row()->fb_id; ?>/picture?type=large" 
                            <?php } else { ?>
                  ...
                  <div id="demo<?php echo $row1['ticket_message_id']; ?>" class="collapse" 
                  style="text-align:justify; border-bottom:1px solid #D8D8D8">
                    <div class="col-md-1">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-6">
                        ...
                        <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('view','<?php echo translate('Просмотреть тикет'); ?>',
