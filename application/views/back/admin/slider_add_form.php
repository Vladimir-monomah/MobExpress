                    ...
                    <div style="width:100%; overflow: hidden !important;" id="preview_div">
                        ...
                        <div id="backup_slider" style="display:none;">
                            <div class="ls-slide" <?php echo $style['full_slide_style']; ?> >
                                <img class="ls-bg out_background"  
                                src="<?php echo base_url(); ?>uploads/slider_image/defaults/
                                <?php echo $style['background']; ?>.jpg" /> 
                ...
                <div class="col-md-12 margin-top-30">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="title" class="form-control required add-tooltip" 
                                data-toggle="tooltip" data-original-title="Write your slider title" > 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                               ...
                               <span class="pull-left btn btn-default btn-file">
                                    ...
                                    <input type="file" name="background" class='bckimg imgr required add-tooltip' 
                                    data-toggle="tooltip">
                                </span>
                            </div>
                        </div>
                            ...
                            _color" style="display:block;">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group demo2">
                                        ...
                                        value="<?php echo $text['color']; ?>" class="form-control color in_
                            ...
                            _background" style="display:block;">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group demo2">
                                        ...
                                        value="<?php echo $text['background']; ?>" class="form-control color in_
