                    ...
                    <div class="tab-content">
                        ...
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <h4 class="text-thin text-center"><?php echo translate('Детали блога'); ?></h4>                            
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                <?php echo translate('Название блога');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" 
                                    placeholder="<?php echo translate('Название блога');?>" 
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ('blog_category','blog_category','name','add','demo-chosen-select required','','','',''); ?>
                                </div>
                            </div>
                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12"><?php echo translate('Картинка');?>
                                </label>
                                <div class="col-sm-6">
                                <span class="pull-left btn btn-default btn-file"> <?php echo translate('Выбрать файл');?>
                                    <input type="file" name="img" onchange="preview(this);" id="demo-hor-12" 
                                    class="form-control required">
                                    </span>
                                    <br><br>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <?php echo translate('Резюме'); ?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                <?php echo translate('Автор');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author" id="demo-hor-1" 
                                    placeholder="<?php echo translate('Автор');?>" class="form-control ">
                                </div>
                            </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        ...
                        onclick="form_submit('blog_add','<?php echo translate('Блог загружен!'); ?>');
