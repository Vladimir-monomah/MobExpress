                        ...
                        <div class="panel">
                            ...
                            ?>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <center>
                                                    ...
                                                    src="<?php echo base_url(); ?>uploads/<?php echo $row;?>/default.jpg"
                                                    <?php
														}else{
													?>
                                                    ...
                                                    <span class="btn btn-default btn-file margin-top-10">
                                                        <?php echo translate('выбрать изображение по умолчанию');?>
                                ...
                                <div class="panel-footer text-right">
                                    ...
                                    data-ing='<?php echo translate('Сохранение'); ?>' data-msg='<?php echo translate($row.'_updated!'); ?>'>
