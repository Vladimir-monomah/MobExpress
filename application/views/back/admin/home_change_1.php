    ...
    <div class="col-md-12">
        ...
        <div class="tab-base horizontal-tab">
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a data-toggle="tab" href="#tabb-3"><?php echo translate('Раздел поиска'); ?></a>
                </li>
                <li>
                ...
                ?>
                <li>
                    <a data-toggle="tab" href="#tabb-6"><?php echo translate('Категория товаров'); ?></a>
                </li>
                <li>
                    ...
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo translate('Слайдер слоя');?></label>
                                <div class="col-sm-6">
                                    <input id="set_slider" class='sw' data-set='set_slider' type="checkbox" 
                                    <?php if($this->crud_model->get_type_name_by_id('general_settings','53','value') == 'ok')
                                    { ?>checked<?php } ?> />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo translate('Верхний слайдер карусели');?></label>
                                <div class="col-sm-6">
                            ...
                            ?>
                                <div class="form-group top_cat">
                                    ...
                                    <div class="col-sm-6">
                                        <?php 
                                            ...
                                            array('ui_settings_id' => 35))->row()->value,true);
                                            $result=array();
                                            ...
                                            $physical_system     =  $this->crud_model->get_type_name_by_id
                                            ('general_settings','68','value');
                                            $digital_system      =  $this->crud_model->get_type_name_by_id
                                            ('general_settings','69','value');
                                            $status= '';
                                            $value= '';
                                            ...
                                            echo $this->crud_model->select_html
                                            ('category','top_category','category_name','edit','demo-cs-multiselect',
                                            json_encode($result),$status,$value,'check_cat_length'); 
                                        ?>
                                    </div>
                                </div>
                                <div class="form-group deal">
                                    <label class="col-sm-3 control-label" >
                                    <?php echo translate('Номер сегодняшней сделки (показать)');?></label>
                                    <div class="col-sm-6">
                                        <input type="number" name="deal_no" 
                                        value="<?php echo $this->crud_model->get_type_name_by_id
                                        ('ui_settings','30','value'); ?>"  class="form-control">
                                    </div>
                                </div>
                                <div class="form-group col-sm-12 top_cat_update"  style="margin-bottom:300px">
                                    ...
                                    ' data-msg='<?php echo translate('Обновлено меню категорий!'); ?>'>
                        ...
                        <div class="col-md-12 form-horizontal">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <?php echo translate('После слайдера'); ?>
                                </h3>
                            </div>
                            <?php
                                        ...
                                        <div class="panel panel-bordered-grey">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <img class="img-responsive img_show img-banner"
                                                            src="<?php echo $this->crud_model->file_view('banner',
                                                            $row['banner_id'],'','','thumb','src','','',$row['image_ext']) ?>" 
                                            ...
                                            <div class="panel-footer text-right">
                                                <span class="btn btn-info btn-xs btn-labeled fa fa-check submitter enterer"  
                                                    data-ing='<?php echo translate('Обновление..');?>' 
                                                        data-msg='<?php echo translate('Баннер обновлен!');?>'>
                                                        <?php echo translate('Обновить');?>
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12 form-horizontal">
                            ...
                            ?>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-2">
                                            <span class="pull-left btn btn-default btn-file margin-top-10">
                                                <?php echo translate('Выбрать изображение');?>
                                ...
                                <div class="form-group col-sm-12">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer" 
                                    type= data-ing='<?php echo translate('Обновление'); ?>
                                    ' data-msg='<?php echo translate('Обновлен раздел поиска!'); ?>'>
                                        <?php echo translate('Обновить');?>
                                    </span>
                                </div>
                            </form>
                ...
                <div id="tabb-4" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                <?php echo translate('Избранные продукты (показать / скрыть)');?></label>
                                <div class="col-sm-6">
                                    <input id="feature_24" 
                                        data-id="24" class='sw2' 
                                            type="checkbox" name="value" 
                                                <?php if($this->crud_model->get_type_name_by_id('ui_settings','24','value') ==
                                                 'ok'){
                                                     ?>checked<?php } ?>
                                                        value="ok" />
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" >
                                <?php echo translate('Количество продуктов (показать)');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo translate('Выберите стиль коробки продукта');?></label>
                                <div class="col-sm-6">
                                    <div class="row">
                                    <?php 
                                        $box_style =  $this->db->get_where('ui_settings',array('ui_settings_id' => 29))->
                                        row()->value;
                                        $style = array(1,2,3);
                                    ...
                                    ?>
                                        <div class="cc-selector col-sm-4">
                                            ...
                                            value="<?php echo $value; ?>" name="fea_pro_box" <?php if($box_style == $value)
                                            { echo 'checked'; } ?> >
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer" 
                                type= data-ing='<?php echo translate('Обновление'); ?>' data-msg=
                                '<?php echo translate('Рекомендуемый раздел обновлен!'); ?>'>
                                    <?php echo translate('Обновить');?>
                                </span>
                            </div>
                        </form>
                ...
                <div id="tabb-5" class="tab-pane fade">
                    <div class="row">
                        ...
                        ?>
                                ...
                                <div class="col-sm-6">
                                    <input id="feature_25" 
                                        data-id="25" class='sw2' 
                                            type="checkbox" name="value" 
                                                <?php if($this->crud_model->get_type_name_by_id('ui_settings','25','value') 
                                                == 'ok'){
                                                     ?>checked<?php } ?>
                                                        value="ok" />
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" >
                                <?php echo translate('Заголовок параллакса для поставщиков');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="pv_title" value="<?php echo $this->
                                    crud_model->get_type_name_by_id('ui_settings','17','value'); ?>"  class="form-control">
                                </div>
                            </div>
                            <div class="form-group margin-top-10">
                                <label class="col-sm-3 control-label margin-top-10" for="demo-hor-inputemail">
                                <?php echo translate('Параллакс-изображение для поставщиков');?></label>
                                <div class="col-sm-9">
                                    <div class="col-sm-5" style="margin:2px;padding:2px;">
                                        <img class="img-responsive img-md img-border img_show2" style="width:100%;height:150px" 
                                        src="<?php echo base_url(); ?>uploads/others/parralax_vendor.jpg" id="blah3" >
                                    </div>
                                    <br />
                                    <br />
                                    <br />
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" ><?php echo translate('номер продавца (показать)');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group col-sm-12">
                                <span class="btn btn-success btn-labeled fa fa-check submitter pull-right enterer" 
                                type= data-ing='<?php echo translate('Обновление'); ?>
                                ' data-msg='<?php echo translate('Обновлен раздел вендоров!'); ?>'>
                                    <?php echo translate('Обновить');?>
                                </span>
                            </div>
                        </form>
