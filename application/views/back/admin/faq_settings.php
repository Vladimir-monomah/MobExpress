    ...
    <div id="page-title">
    	<center>
        	<h1 class="page-header text-overflow">
				<?php echo translate('Управлять часто задаваемыми вопросами')?>
            </h1>
        </center>
    </div>
    <?php
            ...
            <div class="col-md-12">
               ...
               <div class="panel panel-bordered panel-dark">
                        <div class="panel-heading">
                            <center>
                                <h3 class="panel-title"><?php echo translate('FAQ')?></h3>
                            </center>
                        </div>
                        <div class="panel-body" style="background:#fffffb;">
                            ...
                            ?> 
                                <div class="form-group btm_border">
                                    ...
                                    <div class="col-sm-6">
                                          <textarea rows="9"  class="summernotes" data-height="100" data-name="f_a[]">
                                          <?php echo $row1['answer']; ?></textarea>
                                    </div>
                                    <div class="col-sm-2">
                                        <span class="remove_it_v btn btn-danger" onclick="delete_row(this)">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <?php echo translate('Добавить FAQ');?></div>
                                </div>
                            </div>
                        </div>
                     </div>
