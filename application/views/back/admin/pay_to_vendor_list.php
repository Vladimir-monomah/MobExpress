<div class="panel-body" id="demo_s">
     ...
     data-show-toggle="true" data-show-columns="true" data-search="true" >
        <thead>
            <tr>
                ...
                <th><?php echo translate('Поставщик');?></th>
                <th><?php echo translate('Количество');?></th>
                <th><?php echo translate('Метод оплаты');?></th>
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="btn btn-success btn-xs btn-labeled fa fa-usd" data-toggle="tooltip" 
                    onclick="ajax_modal('vendor_payment_status','<?php echo translate('Статус платежа поставщика'); ?>',
                    '<?php echo translate('Успешно отредактирован!'); ?>','vendor_payment_status',
                    '<?php echo $row['vendor_invoice_id']; ?>')" 
                        data-original-title="Edit" data-container="body">
                            <?php echo translate('Статус платежа'); ?>
                </a>
                
                <a onclick="delete_confirm('<?php echo $row['vendor_invoice_id']; ?>',
    ...
    <div id='export-div' style="padding:40px;">
		<h1 id ='export-title' style="display:none;"><?php echo translate('Плата продавцу'); ?></h1>
        ...
        data-width='1500' style="display:none;">
				...
				<tr>
					<td><?php echo $i; ?></td>
                    <td><?php echo $this->db->get_where('vendor',
                    array('vendor_id'=>$row['vendor_id']))->row()->display_name; ?></td>
                    <td><?php echo currency('','def').$row['amount']; ?></td>
