<div class="panel">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo translate('Выбрать тему');?></h3>
    </div>
    <?php
    ...
    ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                        <div class="delete-div-wrap cc-selector col-sm-12" style="border:0px;">
                            <input id="theme_color_<?php echo $n; ?>" type="radio" value="<?php echo $n; ?>" 
                            name="header_color" <?php if($header_color == $n){ echo 'checked'; } ?> >
        ...
        <div class="panel-footer text-right">
            <span class="btn btn-success btn-labeled fa fa-check submitter enterer"  data-ing='<?php echo translate('Сохранение'); ?>'
             data-msg='<?php echo translate('Тема обновлена!'); ?>'>
