                                        ...
                                        <div class="details-wrap">
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    <ol>
                                                        ...
                                                        <li>
                                                        После того, как вы скачали и заполнили файл скелета, загрузите его в форму ниже и отправьте.
                                                        </li>
                                                        <li>
                                                        <code> * Не загружайте более 50 товаров за раз. Добавьте не более двух URL-адресов изображений для каждого продукта. </code>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <div>
                                                        <a class="btn btn-sm btn-primary btn-dark" target="_blank" download
                                                           ...
                                                           "uploads/bulk_skeletons/product.xlsx" ?>">
                                                           <?php echo translate('Загрузить файл скелета массовой загрузки продукта'); ?>
                                                           </a>
                                                        <a class="btn btn-sm btn-primary" target="_blank" download
                                                           href="<?php echo base_url() . 
                                                           "uploads/bulk_skeletons/product_example.xlsx" ?>">
                                                           <?php echo translate('Скачать файл примера массовой загрузки продукта'); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    <ol>
                                                        <li>
                                                        Категория, подкатегория и бренд должны быть в <code> числовых идентификаторах </code>. Щелкните <code> уважаемые модальные / всплывающие окна </code>, чтобы просмотреть связанные идентификаторы.
                                                        </li>
                                                        <li>
                                                        Налог и скидка могут быть в процентах. Например, если скидка 15, напишите только 15. Если скидка 15 процентов, напишите 15%. Сделайте то же самое для налога.
                                                        </li>
                                                        <li>
                                                        Теги разделяются запятыми. Если у вас есть такие теги, как "ребенок" и "еда", напишите <code> ребенок, еда </code>.
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>Для автоматической публикации заполните столбец «опубликовано» <code>да</code> </li>
                                                        <li>
                                                        Товары должны быть успешно загружены.
                                                        </li>
                                                    </ol>
                                                    ...
                                                    <div>
                                                        ...
                                                        <button data-target="#product_category" type="button" class="btn btn-primary"
                                                                data-toggle="modal"><?php echo translate("Список идентификаторов категорий") ?></button>
                                                        <button data-target="#product_sub_category" type="button" class="btn btn-primary"
                                                                data-toggle="modal"><?php echo translate("Список идентификаторов подкатегорий") ?></button>
                                                        <button data-target="#product_brand" type="button" class="btn btn-primary"
                                                                data-toggle="modal"><?php echo translate("Список идентификаторов брендов") ?></button>
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title" id=""><?php echo translate('ID категорий')?></h5>
                                                                    </div>
                                                            ...
                                                            <div class="modal-dialog modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title" id=""><?php echo translate('Идентификаторы брендов')?></h5>
                                                                    ...
                                                                    <div class="modal-body" style="overflow:scroll; max-height:400px;">
                                                                        <?php if(!empty($brands)){ ?>
                                                                            <table class="table table-bordered table-responsive dataTable">
                                                                                <tr>
                                                                                    <th><?php echo translate('Идентификатор бренда')?></th>
                                            ...
                                            <div class="panel mb-0">
                                                ...
                                                <span class="btn btn-default btn-file">
                                                    ...
                                                    <div class="form-group">
                                                        <button class="btn btn-mint btn-labeled fa fa-upload" type="submit">
                                                        <?php echo translate("Загрузить продукты") ?></button>
                                                    </div>
                                                    <?php echo form_close() ?>
