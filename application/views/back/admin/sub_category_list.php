    ...
    data-ignorecol="0,3" data-show-toggle="true" data-show-columns="false" data-search="true" >
        <thead>
            <tr>
                ...
                <th><?php echo translate('Бренды');?></th>
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    onclick="ajax_modal('edit','<?php echo translate('Редактировать подкатегорию (физический продукт)'); ?>',
                    '<?php echo translate('Успешно отредактирован!'); ?>','sub_category_edit',
