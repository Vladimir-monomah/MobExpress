<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate('Управлять набором продуктов');?></h1>
	</div>
        <div class="tab-base">
            <div class="panel">
                    ...
                    <div class="tab-content">
                        <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
                            <button class="btn btn-primary btn-labeled fa fa-plus-circle add_pro_btn pull-right" 
                                onclick="ajax_set_full('add','<?php echo translate('Добавить набор продуктов'); ?>',
                                '<?php echo translate('Успешно добавлен!'); ?>','product_bundle_add',''); 
                                proceed('to_list');"><?php echo translate('Создать пакет продуктов');?>
                            </button>
                            <button class="btn btn-info btn-labeled fa fa-step-backward pull-right pro_list_btn" 
                                ...
                                <?php echo translate('Назад к списку комплектов продуктов');?>
                            </button>
                        </div>
                    <!-- LIST -->
