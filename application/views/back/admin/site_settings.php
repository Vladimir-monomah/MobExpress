        ...
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-toggle="tab" href="#demo-stk-lft-tab-1"><?php echo translate('Общие настройки'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-5"><?php echo translate('Настройки smtp'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab"
                           href="#demo-stk-lft-tab-6"><?php echo translate('Настройки аффилированности'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-2"><?php echo translate('Социальные сети'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab"
                           href="#demo-stk-lft-tab-3"><?php echo translate('Условия и положения'); ?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-4"><?php echo translate('Политика конфиденциальности'); ?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content bg_grey">
                    ...
                    <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Общие настройки'); ?></h3>
                            </div>
                            <?php
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="system_name"
                                               ...
                                               ('general_settings', '1', 'value'); ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo translate('Системная электронная почта'); ?></label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo translate('Системное название'); ?></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="system_title"
                                               value="<?php echo $this->crud_model->get_type_name_by_id
                                               ('general_settings', '3', 'value'); ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo translate('Время кеширования домашней страницы'); ?>
                                        (<?php echo translate('Минуты'); ?>)</label>
                                    <div class="col-sm-4">
                                        <input type="number" min='0' step='.01' name="cache_time"
                                               value="<?php echo $this->crud_model->get_type_name_by_id
                                               ('general_settings', '59', 'value'); ?>"
                                               class="form-control">
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo translate('Имя папки загружаемого продукта'); ?></label>
                                    <div class="col-sm-6">
                                        <input type="text" name="file_folder"
                                               value="<?php echo $this->crud_model->get_type_name_by_id
                                               ('general_settings', '60', 'value'); ?>"
                                               class="form-control">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo translate('Язык'); ?></label>
                                    <div class="col-sm-6">
                                        <select name="language" class="demo-cs-multiselect">
                                            <?php
                                            $set_lang = $this->db->get_where('general_settings', 
                                            array('type' => 'language'))->row()->value;
                                            ...
                                            foreach ($fields as $field) {
                                                if ($field !== 'word' && $field !== 'word_id') {
                                                    ...
                                                    <option value="<?php echo $field; ?>" <?php if ($set_lang == $field) {
                                                        echo 'selected';
                                                    } ?> ><?php echo $this->db->get_where('language_list', 
                                                    array('db_field' => $field))->row()->name; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('Объем уведомлений администратора'); ?>
                                    </label>
                                    <div class="col-sm-4">
                                        <div class="range-def" data-start="<?php echo($ad_volume * 10); ?>" data-min="0"
                                             data-max="10"></div>
                                        <div>
                                            <strong><?php echo translate('Объём_:_'); ?></strong>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('Звук уведомления домашней страницы'); ?>
                                    </label>
                                    <div class="col-sm-6">
                                        <input id="home_noti_sound" class='sw4' data-set='set_home_notification_sound'
                                               type="checkbox"
                                               <?php if ($this->crud_model->get_type_name_by_id
                                               ('general_settings', '49', 'value') == 'ok'){ ?>checked<?php } ?> />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('Объем уведомлений на домашней странице'); ?>
                                    </label>
                                    <div class="col-sm-4">
                            ...
                            <div class="panel-footer text-right">
                                    <span class="btn btn-success btn-labeled fa fa-check submitter enterer"
                                          type="submit" data-ing='<?php echo translate('Сохранение'); ?>'
                    ...
                    <div id="demo-stk-lft-tab-5"
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Настройки smtp'); ?></h3>
                            </div>
                            <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="mail_status" class='sw4' data-set='mail_status' type="checkbox"
                                               <?php if ($this->crud_model->get_settings_value
                                               ('general_settings', 'mail_status', 'value') == 'smtp'){ ?>checked<?php } ?> />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('smtp хост'); ?>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="smtp_host" class="form-control"
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'smtp_host', 'value'); ?>">
                                    </div>
                                </div>
                                <!-- Smtp Port  -->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('smptp порт'); ?>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="smtp_port" class="form-control"
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'smtp_port', 'value'); ?>">
                                    </div>
                                </div>
                                <!-- Smtp User  -->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('smtp пользователь'); ?>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="smtp_user" class="form-control"
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'smtp_user', 'value'); ?>">
                                    </div>
                                </div>
                                <!-- Smtp Password  -->
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('пароль smtp'); ?>
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="password" name="smtp_pass" class="form-control"
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'smtp_pass', 'value'); ?>">
                                    </div>
                                </div>
                            </div>
                            <!--SAVE---------->
                    ...
                    <div id="demo-stk-lft-tab-6"
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Настройки аффилированности'); ?></h3>
                            </div>
                            <?php
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('Действительность аффилированности'); ?>
                                    </label>
                                    <div class="col-sm-3">
                                        <input type="number" step="1" min="1" name="affiliation_validity"
                                               ...
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'affiliation_validity', 'value'); ?>">
                                    </div>
                                    <div class="col-sm-3">
                                            <small><?php echo translate
                                            ('По истечении этого количества дней срок действия партнерского кода истечет'); ?></small>
                                            <small><?php echo translate('По умолчанию 30 дней'); ?></small>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">
                                        <?php echo translate('Точка привязки к курсу валюты'); ?>
                                    </label>
                                    <div class="col-sm-3">
                                        <input type="number" step=".1" min="0" name="affiliation_point_to_currency_rate"
                                               ...
                                               value="<?php echo $this->crud_model->get_settings_value
                                               ('general_settings', 'affiliation_point_to_currency_rate', 'value'); ?>">
                                    </div>
                                    <div class="col-sm-3">
                                            <small><?php echo translate('1 балл = X ед. Вашей валюты '); ?></small>
                                            <small><?php echo translate
                                            ('Ввод здесь 3,2 означает, что если вы конвертируете 10 партнерских баллов в кошелек,
                                             вы получите 10 x 3,2 = 32 вашей валюты.'); ?></small>
                                            <small><?php echo translate('По умолчанию 1 A.P. = 1 Фактическая валюта'); ?></small>
                                    </div>
                                </div>
                            </div>
                            <!--SAVE---------->
                    ...
                    <div id="demo-stk-lft-tab-2"
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Социальные сети'); ?></h3>
                            </div>
                            <?php
                    ...
                    <div id="demo-stk-lft-tab-3" class="tab-pane fade">
                        <div class="panel">
                            ...
                            ?>
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Условия и положения'); ?></h3>
                            </div>
                            <?php
                    ...
                    <div id="demo-stk-lft-tab-4" class="tab-pane fade">
                        <div class="panel">
                            ...
                            ?>
                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('Политика конфиденциальности'); ?></h3>
                            </div>
                            <?php
