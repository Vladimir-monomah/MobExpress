...
<div id="content-container"> 
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Настройки экрана');?></h1>
    </div>
    <div class="tab-base">
        <div class="panel">
            <div class="tab-base tab-stacked-left">
                <ul class="nav nav-tabs" style="display:none;">
                    <li class="active">
                        <a data-toggle="tab" href="#tab-1" id="theme"><?php echo translate('Цвет темы');?></a>
                    </li>
                    
                    <li>
                        <a data-toggle="tab" href="#tab-2" id="logo"><?php echo translate('Логотип');?></a>
                    </li>
                    
                    <li>
                        <a data-toggle="tab" href="#tab-3" id="favicon"><?php echo translate('Иконка');?></a>
                    </li>
                    
                    <li>
                        <a data-toggle="tab" href="#tab-4" id="font"><?php echo translate('Фон');?></a>
                    </li>
                    
                    <li>
                        <a data-toggle="tab" href="#tab-5" id="preloader"><?php echo translate('Прелоадер');?></a>
                    </li>
                     <li>
                        <a data-toggle="tab" href="#tab-6" id="home"><?php echo translate('Доманяя страница');?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#tab-7" id="contact"><?php echo translate('Контакт');?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#tab-9" id="header"><?php echo translate('Заголовок');?></a>
                    </li>
                     <li>
                        <a data-toggle="tab" href="#tab-8" id="footer"><?php echo translate('Подвал');?></a>
                    </li>
