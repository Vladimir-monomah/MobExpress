	<div class="panel-body" id="demo_s">
		<table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,2" 
		data-show-toggle="true" data-show-columns="false" data-search="true" >
			...
			<tr>
				...
				<td class="text-right">
					...
					<a onclick="delete_confirm('<?php echo $row['blog_category_id']; ?>',
	...
	<div id='export-div'>
		<h1 style="display:none;"><?php echo translate('Блог категории'); ?></h1>
