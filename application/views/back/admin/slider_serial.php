                ...
                <div class="dd" id="nestable">
                    <ol class="dd-list">
                        ...
                        <li class="dd-item row" data-id="<?php echo $row['slider_id']; ?>">
                            ...
                            style="cursor: ns-resize;moz-user-select: none; -khtml-user-select: none; 
                            -webkit-user-select: none; -o-user-select: none; ">
                            	<div class="col-md-8">
                            	   <img class="img-responsive thumbnail img-slider" style="margin-bottom:0px !important;" 
                                   src="<?php echo base_url(); ?>uploads/slider_image/background_
                                   <?php echo $row['slider_id']; ?>.jpg" />
                                </div>
                                <div class="col-md-4">
                                	<?php echo $row['title']; ?>
                                </div>
        ...
        <div class="panel-footer">
            <div class="row">
                ...
                <div class="col-md-1">
                    ...
                    onclick="form_submit('slider_serial','<?php echo translate('Серийник слайдера сохранен!'); ?>');" >
