            ...
            <div class="panel-heading">
                <div class="panel-control" style="float: left;">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#business_details"><?php echo translate('Детали'); ?></a>
                        </li>
                        <li>
                            <a data-toggle="tab" href="#requirements_tab"><?php echo translate('Требования'); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <?php echo translate('Добавить логотип');?></label>
                                <div class="col-sm-6">
                                	<img class="img-responsive blah" width="100px"  
                                    src="<?php echo base_url(); ?>uploads/digital_logo_image/<?php echo $row['logo']; ?>"  >
                                    <br>
                                	<span class="pull-left btn btn-default btn-file"> <?php echo translate('Выбрать логотип');?>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    $row['category'],'digital','ok','get_cat'); ?>
                                </div>
                            </div>
                            <div class="form-group btm_border" id="sub" >
                                ...
                                <div class="col-sm-6" id="sub_cat">
                                    ...
                                    'sub_category_name','edit','demo-chosen-select required',$row['sub_category'],
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    placeholder="<?php echo translate('Теги');?>" value="<?php echo $row['tag']; ?>" 
                                    class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-4 control-label" for="demo-hor-12"><?php echo translate('Картинки');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php 
                                        $images = $this->crud_model->file_view('product',$row['product_id'],'','',
                                        'thumb','src','multi','all');
                                        if($images){
                            ...
                            <div class="form-group btm_border" id="vdo_add_selector">
                                ...
                                <div class="col-sm-6">
                                    <h4 class="pull-left">
                                        ...
                                        ('если вам нужно добавить видео для вашего продукта, нажмите здесь ...');?></i>
                                    </h4>
                                    <div id="vdo_add_btn" class="btn btn-mint btn-labeled fa fa-plus pull-right">
                                    <?php echo translate('Добавить виидео');?></div>
                                </div>
                            </div>
                            <?php
								}else{
                            ...
                            <div class="form-group btm_border" id="video_share" style="display:none">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 abstract">
                                        <select class="demo-chosen-select" name="site" id="site">
                                            <option><?php echo translate('Выбери один');?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 abstract">
                                        ...
                                        onchange="video_preview(this.value)" />
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group btm_border" id="product_file" >
                                <label class="col-sm-4 control-label" for="demo-hor-12">
                                <?php echo translate('Обновить файл продукта');?></label>
                                <div class="col-sm-6">
                                    <span class="pull-left btn btn-default btn-file"> 
                                    <?php echo translate('Выбрать файл');?> (<?php echo translate('сжатый');?> *.zip/*.rar)
                                        <input type="file" name="product_file" onchange="preview_details(this);
                                        " id="digital_file" class="form-control"  accept='application/zip,application/rar'>
                                    </span>

                                    <br><br>
                                    <span>
                                        <?php echo translate('максимальный размер').' : '.ini_get("upload_max_filesize"); ?>
                                    </span>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <label class="col-sm-4 control-label" for="">
                                    <?php echo translate('Дружественный заголовок SEO');?>
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                        <textarea name="seo_description"
                                                  placeholder="<?php echo translate('Ex. New Yamaha Sports bike in 2021 from Japan')?>"
                                                  class="form-control required" rows='4' ><?php echo $row['seo_description']; ?>
                                        </textarea>
                                </div>
                                <div class="col-sm-2"></div>
                            </div>
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    placeholder="<?php echo translate('Цена');?>" class="form-control required">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?></span>
                            </div>
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    placeholder="<?php echo translate('Налог на продукцию');?>" class="form-control">
                                </div>
                                <div class="col-sm-1">
                                    <select class="demo-chosen-select" name="tax_type">
                                        ...
                                        <?php echo currency('','def'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-10">
                                <?php echo translate('Скидка на товар');?></label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-1">
                                    <select class="demo-chosen-select" name="discount_type">
                                        ...
                                        { echo 'selected'; } ?> ><?php echo currency('','def'); ?></option>
                                    </select>
                                </div>
                            </div> 
                        </div>         
                        <div id="requirements_tab" class="tab-pane fade">
                        	<div class="row">
                                <div id="requirements" class="col-sm-8 col-sm-offset-2">
                                    ...
                                    <div class="rem">
                                        <div class="form-group additional_box">
                                            <div class="col-sm-12">
                                                <input type="text" name="req_title[<?php echo $row1['index']; ?>]" 
                                                placeholder="<?php echo translate('Название поля');?>" 
                                                value="<?php echo $row1['field'];?>" class="form-control required">
                                            </div>
                                            <div class="col-sm-12">
                                                <textarea rows="9"  class="summernotes" data-height="200" 
                                                data-name="req_desc[<?php echo $row1['index']; ?>]">
                                                <?php echo $row1['desc']; ?></textarea>
                                            </div>
                                            <div class="col-sm-12">
                                                <button class="pull-right btn btn-danger removal">
                                                    <?php echo translate('Удалять');?>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-8 col-sm-offset-2">
                                    <h4 class="pull-left">
                                        <i><?php echo translate
                                        ('если вам нужно добавить требования к этому продукту для клиентов, нажмите здесь.');?></i>
                                    </h4>
                                    <div id="add_requirements" class="btn btn-mint btn-labeled fa fa-plus pull-right">
                                        <?php echo translate('Добавить требования к продукту');?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            ...
                            '<?php echo translate('Успешно отредактирован!'); ?>','digital_edit',
                            '<?php echo $row['product_id']; ?>') "><?php echo translate('Обновить');?>
                        </span>
                     </div>
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" 
                         onclick="form_submit('digital_edit','<?php echo translate('Успешно отредактирован!'); ?>');
...
<div id="requirements_dummy" style="display:none;">
    <div class="rem">
    	<div class="form-group additional_box">
            <div class="col-sm-12">
                <input type="text" name="req_title[{{i}}]" 
                placeholder="<?php echo translate('Название поля');?>" class="form-control required">
            </div>
            <div class="col-sm-12">
	...
	<div id="option_set">
        ...
        <div class="col-sm-6">
            <select class="demo-chosen-select_o" name="upload_method" onchange="video_sector(this.value)">
                <option value="default" selected><?php echo translate('Выберите опцию');?></option>
                <option value="upload"><?php echo translate('Загрузить видео')?></option>
                <option value="share"><?php echo translate('Поделиться ссылкой');?></option>
                <option value="not_now"><?php echo translate('Я хочу добавить видео позже');?></option>
            </select>
        </div>
    </div>
</div>
	...
	<div id="change_option_set">
        ...
        <div class="col-sm-6">
            <select class="demo-chosen-select_o" name="upload_method" onchange="video_change_sector(this.value)">
                ...
                <option value="upload"><?php echo translate('Загрузить видео')?></option>
                <option value="share"><?php echo translate('Поделиться ссылкой');?></option>
                <option value="not_now"><?php echo translate('Я хочу сменить видео позже');?></option>
                <option value="delete"><?php echo translate('Я хочу удалить существующее видео');?></option>
            </select>
        </div>
    </div>
</div>
