        ...
        <div class="col-md-12">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-name"><b><?=translate('Название пакета')?></b></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-amount"><b><?=translate('Количество')?></b></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="post_amount"><b><?=translate('Загрузка продукта')?>:</b></label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="image"><b><?=translate('Картинка пакета')?>:</b></label>
                    <div class="col-sm-10">
                        <div class="col-sm-6" style="margin:2px; padding:2px;">
                            <?php
                                ...
                                ?>
                                    <img class="img-responsive img-border blah" src="<?=base_url()?>uploads/plan_image/
                                    <?=$images[0]['image']?>" class="img-sm">
                                <?php
                                }
                                else {
                                ?>
                                    <img class="img-responsive img-border blah" 
                                    src="<?=base_url()?>uploads/plan_image/default_image.png" class="img-sm">
                                <?php
                                }
                            ?>
                        </div>
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right loc" 
                        onclick="form_submit('package_uploader_edit', '<?php echo translate('Успешно отредактирован!'); ?>')" >
