<div class="panel">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo translate('Прелоадеры');?></h3>
    </div>
    <?php
            ...
            <div class="col-sm-12 ">
                <div class="form-group" style="margin-top:20px;">
                    <label class="col-sm-2 control-label" for="demo-hor-inputemail">
                        <?php echo translate('Цвет прелоадера'); ?>
                    </label>
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-inputemail">
                        <?php echo translate('Фон прелоадера'); ?>
                    </label>
                    <div class="col-sm-8">
                        <div class="col-sm-12">
                            <div class="input-group demo2">
            ...
            <div class="col-sm-12 ">
                <div class="panel-footer text-right">
                    <span class="btn btn-success btn-labeled fa fa-check submitter enterer" 
                     data-ing='<?php echo translate('Сохранение'); ?>' data-msg='<?php echo translate('Прелоадер обновлён'); ?>'>
                        <?php echo translate('Сохранение');?>
                    </span>
                </div>
            </div>
        </div>
