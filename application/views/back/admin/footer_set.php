    ...
    <div class="panel">
        ...
        ?>
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-inputemail">
                        <?php echo translate('Категория подвала'); ?>
                    </label>
                    <div class="col-sm-8">
                        <?php
                            ...
                            select_html('category','footer_category','category_name','edit','demo-cs-multiselect',
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="demo-hor-inputemail">
                        <?php echo translate('Текст подвала'); ?>
                    </label>
                    <div class="col-sm-8">
                        <div class="col-sm-">
            ...
            <div class="panel-footer text-right">
                <span class="btn btn-success btn-labeled fa fa-check submitter"  data-ing='<?php echo translate('Сохранение'); ?>' 
