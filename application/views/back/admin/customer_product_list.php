...
<div class="panel-body" id="demo_s">
    <table id="events-table" class="table table-striped"  data-url="<?php echo base_url(); ?>admin/customer_products/list_data" 
        ...
        <thead>
            <tr>
                ...
                <th data-field="uploaded_by" data-sortable="true">
                    <?php echo translate('Загрузка');?>
                </th>
                <th data-field="customer_status" data-sortable="false">
                    <?php echo translate('Статус клиента');?>
                </th>
