...
<div class="panel-heading">
    <div class="panel-control" style="float: left;">
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#full"><?php echo translate('Полный счёт'); ?></a>
            </li>
            <?php
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <img class="img-responsive logo" src="<?php echo $this->crud_model->logo('home_top_logo'); ?>" 
                                alt="Active Super Shop" width="55%"><br><br>
                                <?php if($row['buyer'] == 'guest'){?>
                                <b class="pull-left">
                                    <?php echo translate('Ссылка на счёт');?> <?php echo base_url() ?>home/guest_invoice/<?php 
                                    echo $row['guest_id']; ?>
                                </b>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <?php if($row['buyer'] == 'guest'){?>
                                <b class="pull-right">
                                    <?php echo translate('Идентификатор гостя:');?> :<?php echo $row['guest_id']; ?>
                                </b>
                                <br>
                                <?php }?>
                                <b class="pull-right">
                                    <?php echo translate('Счёт фактура:');?> :<?php echo $row['sale_code']; ?>
                                </b>
                                <br>
                                <?php }?>
                                <b class="pull-right">
                                    <?php echo translate('Дата:');?> <?php echo date('d M, Y',$row['sale_datetime'] );?>
                                </b>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 pad-top">
                            ...
                            <!--Panel heading-->
                                <div class="panel panel-bordered-grey shadow-none">
                                    <div class="panel-heading">
                                        <h1 class="panel-title"><?php echo translate('Информация о клиенте');?></h1>
                                    </div>
                                    <!--List group-->
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><b><?php echo translate('Имя');?></b></td>
                                                <td><?php echo $info['firstname']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo translate('Фамилия');?></b></td>
                                                <td><?php echo $info['lastname']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo translate('Телефон');?></b></td>
                            ...
                            <!--Panel heading-->
                                <div class="panel panel-bordered-grey shadow-none">
                                    <div class="panel-heading">
                                        <h1 class="panel-title"><?php echo translate('Реквизиты платежа');?></h1>
                                    </div>
                                    <!--List group-->
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><b><?php echo translate('Статус платежа');?></b></td>
                                                <td><i><?php echo translate($this->crud_model->
                                                sale_payment_status($row['sale_id'])); ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo translate('Метод оплаты');?></b></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><b><?php echo translate('Дата оплаты');?></b></td>
                                ...
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo translate('"Элемент"');?></th>
                                            <th><?php echo translate('Опции');?></th>
                                            <th><?php echo translate('Количество');?></th>
                                            <th><?php echo translate('Себестоимость единицы продукции');?></th>
                                            <th><?php echo translate('Итог');?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        <tr>
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach ($products as $product) { ?>
                                                            <a style="font-size: 12px;">
                                                                <?php echo $this->db->get_where('product', 
                                                                array('product_id' => $product['product_id']))->row()->title . 
                                                                '<br>';?>
                                                            </a>
                                                    <?php
                                                        }
                                            ...
                                            <td><?php echo currency('','def').$this->cart->
                                            format_number($row1['price']); ?></td>
                                            <td><?php echo currency('','def').$this->cart->
                                            format_number($row1['subtotal']); $total += $row1['subtotal']; ?></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 pull-right margin-top-20">
                                    <div class="panel panel-colorful panel-grey shadow-none">
                                        <table class="table" border="0">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Промежуточная сумма');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($total); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Налог');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($row['vat']); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Перевозка');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($row['shipping']); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Общая сумма');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($row['grand_total']); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <!--Panel heading-->
                                    <div class="panel panel-colorful panel-grey shadow-none">
                                        ...
                                        <table class="table" border="0">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Адресная строка 1');?></b></td>
                                                    <td><?php echo $info['address1']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Адресная строка 2');?></b></td>
                                                    <td><?php echo $info['address2']; ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Индекс');?></b></td>
                                    ...
                                    <div class="panel panel-bordered-grey shadow-none">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Статус платежа');?></b></td>
                                                    <td><?php echo translate($this->crud_model->
                                                    sale_payment_status($row['sale_id'])); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Метод платежа');?></b></td>
                                                    <td>
                                                        <?php if($info['payment_type'] == 'c2'){
                                                            echo 'TwoCheckout';
                                                        }
                                                ...
                                                <tr>
                                                    <td><b><?php echo translate('Дата платежа');?></b></td>
                                                    <td><?php echo date('d M, Y',$row['sale_datetime'] );?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                ...
                                alt="Active Super Shop" width="55%">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <b class="pull-right">
                                    <?php echo translate('Счёт фактура');?> :<?php echo $row['sale_code']; ?>/<?php echo $ven; ?>
                                </b>
                                <br>
                                <b class="pull-right">
                                    <?php echo translate('Дата');?> <?php echo date('d M, Y',$row['sale_datetime'] );?>
                        ...
                        <div class="col-md-12 pad-top">
                            ...
                            <!--Panel heading-->
                                <div class="panel panel-bordered-grey shadow-none">
                                    <div class="panel-heading">
                                        <h1 class="panel-title"><?php echo translate('Детали платежа');?></h1>
                                    </div>
                                    <!--List group-->
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><b><?php echo translate('Статус платежа');?></b></td>
                                                <td><i><?php echo translate($this->crud_model->
                                                sale_payment_status($row['sale_id'],'vendor',$ven)); ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo translate('Метод платежа');?></b></td>
                                                <td>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 pull-right margin-top-20">
                                    <div class="panel panel-colorful panel-grey shadow-none">
                                        <table class="table" border="0">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Сромежуточная сумма');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($total); ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><b><?php echo translate('Перевозки');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->format_number
                                                    ($shipping); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Общая сумма');?></b></td>
                                                    <td><?php echo currency('','def').$this->cart->
                                                    format_number($total+$vat+$shipping); ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Статус платежа');?></b></td>
                                                    <td><?php echo translate($this->crud_model->
                                                    sale_payment_status($row['sale_id'],'vendor',$ven)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Метод платежа');?></b></td>
                                                    <td>
                ...
                <div id="quart" class="tab-pane fade">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 pad-all">
                                <b class="pull-right">
                                    <?php echo translate('Счёт фактура');?> : <?php echo $row['sale_code']; ?> / A
                                </b>
                                <br>
                                <b class="pull-right">
                                    <?php echo translate('Дата:');?> <?php echo date('d M, Y',$row['sale_datetime'] );?>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td><b><?php echo translate('Статус платежа');?></b></td>
                                                <td><i><?php echo translate($this->crud_model->
                                                sale_payment_status($row['sale_id'],'admin')); ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b><?php echo translate('Метод платежа');?></b></td>
                                                <td>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td><b><?php echo translate('Статус платежа');?></b></td>
                                                    <td><?php echo translate($this->crud_model->
                                                    sale_payment_status($row['sale_id'],'admin')); ?></td>
                                                </tr>
                                                <tr>
                                                    <td><b><?php echo translate('Метод оплаты');?></b></td>
                                                    <td>
...
<script>
	$.getScript("http://maps.google.com/maps/api/js?v=3.exp&signed_in=true&callback=MapApiLoaded&key=
    <?php echo $this->db->get_where('general_settings',array('type' => 'api_key'))->row()->value; ?>", function () {});
