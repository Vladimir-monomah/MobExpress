<div id="content-container">
	<div id="page-title">
		...
		<?php echo translate('Управлять штабами');?>
		</h1>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div class="col-md-12" 
						...
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt"
                        	onclick="ajax_modal('add','<?php echo translate('Добавить персонал');?>',
							'<?php echo translate('Успешно добавлен!');?>','admin_add','')" >
							<?php echo translate('Создать администратора');?>
						</button>
					</div>
					<br>
