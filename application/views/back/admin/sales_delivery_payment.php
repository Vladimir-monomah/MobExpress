<div>
    ...
    ?>
        <div class="panel-body">
                    ...
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Статус платежа'); ?></label>
                        ...
                        ?>
                            <?php
                                ...
                                ($from,'payment_status','','edit','demo-chosen-select',$payment_status);
                            ?>
                        <?php
                            } else if($payment_type == 'paypal' || $payment_type == 'stripe' || 
                            $payment_type == 'c2' || $payment_type == 'wallet'){
                        ?>
                            <input type="text" class="form-control" name="payment_status" 
                            value="<?php echo $payment_status; ?>" readonly />
                        <?php
                            }
                        ?>
                        </div>
            ...
            ?>
            <center>
                <h3><?php echo translate('Нет продукта от администратора'); ?></h3>
            </center>
            <script>
            ...
            ?>
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('Статус доставки'); ?></label>
                    <div class="col-sm-6">
                        <?php
                            $from = array('pending','on_delivery','delivered');
                            echo $this->crud_model->select_html($from,'delivery_status','','edit','demo-chosen-select',
                            $delivery_status);
                        ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-2"><?php echo translate('Подробности о статусе доставки'); ?>
                    </label>
                    <div class="col-sm-6">
