		...
		?>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Название купона');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="title" id="demo-hor-1" value="<?php echo $row['title']; ?>" 
                            placeholder="<?php echo translate('Название'); ?>" class="form-control required">
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Действителен до');?></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group" style="display:none;">
                    <label class="col-sm-4 control-label"><?php echo translate('купон на скидку на');?></label>
                    <div class="col-sm-6">
                        <?php
                            $array = array('all_products','category','sub_category','product');
                            echo $this->crud_model->select_html($array,'set_type','','edit','demo-chosen-select required chos',
                             $spec['set_type']); 
                        ?>
                    </div>
                </div>      
                ...
                <div class="form-group category" <?php if($spec['set_type'] !== 'category'){ ?>style="display:none;"<?php } ?>>
                    ...
                    <div class="col-sm-6">
                        <?php 
                        	...
                        	echo $this->crud_model->select_html('category','category','category_name','edit','demo-cs-multiselect'
                            ,json_encode($result),$status,$value);
                        ?>
                    </div>
                </div>
                
                <div class="form-group sub_category" <?php if($spec['set_type'] !== 'sub_category'){ ?>style="display:none;"<?php }?>>
                    <label class="col-sm-4 control-label"><?php echo translate('Подкатегория');?></label>
                    <div class="col-sm-6">
                        <?php 
							...
							foreach($sub_categories as $row2){
                         	...
                         	echo $this->crud_model->select_html('sub_category','sub_category','sub_category_name','edit',
                             'demo-cs-multiselect',json_encode($result),$status,$value);
                        ?>
                    </div>
                </div>
                
                <div class="form-group product" <?php if($spec['set_type'] !== 'product'){ ?>style="display:none;"<?php } ?>>
                    <label class="col-sm-4 control-label"><?php echo translate('Продукт');?></label>
                    <div class="col-sm-6">
                        <?php 
							...
							if($physical_system !== 'ok' && $digital_system !== 'ok'){
                              ...
                              json_encode($result),$status2,$value2);
                        ?>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Код купона');?></label>
                    <div class="col-sm-6">
                        <input type="text" name="code" id="demo-hor-1"  value="<?php echo $row['code']; ?>"
                            placeholder="<?php echo translate('Код'); ?>" class="form-control required">
                    </div>
                </div>
                
                <div class="form-group">
                    <label class="col-sm-4 control-label"><?php echo translate('Тип скидки');?></label>
                    <div class="col-sm-6">
                        <?php
