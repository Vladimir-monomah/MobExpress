<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,3" 
    data-show-toggle="true" data-show-columns="false" data-search="true" >
        <thead>
            <tr>
                <th><?php echo translate('Id');?></th>
                <th><?php echo translate('Знак');?></th>
                <th><?php echo translate('Название');?></th>
                <th><?php echo translate('Цена');?></th>
                <th><?php echo translate('За');?></th>
        ...
        <tr>
            ...
            <td><?php echo translate('Продолжительность жизни');?></td>
            <td class="text-right">
        ...
        <tr>
            ...
            <td><?php echo $row['timespan']; ?> <?php echo translate('Дни');?></td>
            <td class="text-right">
                <a class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip" 
                    onclick="ajax_modal('edit','<?php echo translate('Редактировать пакет поставщика'); ?>',
                    '<?php echo translate('successfully_edited!'); ?>','membership_edit','<?php echo $row['membership_id']; ?>')"
                     data-original-title="Edit" data-container="body">
                        <?php echo translate('Редактировать');?>
                </a>
                <a onclick="delete_confirm('<?php echo $row['membership_id']; ?>',
