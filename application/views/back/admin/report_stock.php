...
<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate('Управлять отчетом о запасах');?></h1>
	</div>
    <div class="tab-base">
        <div class="panel">
                			...
                			<div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        select_html('category','category','category_name','add','demo-chosen-select','','','',
                                        'get_cat'); ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="pro" style="display:none;">
                                    ...
                                    <?php echo translate('Товар'); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-sm-7 col-sm-offset-5">
                                        <button class="btn btn-primary btn-lg btn-labeled fa fa-file-text enterer">
                                            <?php echo translate('Получить отчет о запасах');?>
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-bordered-primary margin-top-10 margin-all-15">
                            <?php if(isset($product)){ ?>
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo translate('Акции'); ?>: <?php echo $product_name; ?></h3>
                                </div>
