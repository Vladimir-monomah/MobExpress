...
<div>
    ...
    ?>
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label"><?php echo translate('Купонная скидка на');?></label>
                <div class="col-sm-6">
                    <?php
            ...
            <div class="form-group sub_category" style="display:none;">
                ...
                <div class="col-sm-6">
                    <?php 
                        echo $this->crud_model->select_html('sub_category','sub_category','sub_category_name','add',
                        'demo-cs-multiselect','',$status,$value); 
                    ?>
                </div>
            </div>
