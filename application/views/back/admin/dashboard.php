...
<div id="content-container">	
    <div id="page-title">
        <h1 class="page-header text-overflow"><?php echo translate('Информационная панель');?></h1>
    </div>
    <div id="page-content">
        ...
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') == 'ok'){}
            ...
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-purple">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Наличных за 24 часа');?></h3>
                    </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Распродажи за 24 часа');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
            ...
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-black">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Убыток за 24 часа');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
		...
		?>
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','68','value') !== 'ok' && 
        $this->crud_model->get_type_name_by_id('general_settings','69','value') == 'ok'){}else{ ?>style="display:none;"<?php } ?> >
            <div class="col-md-12 col-lg-12">
                <div class="panel panel-bordered panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Распродажа за 24 часа');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
        ...
        <div class="row" <?php if($this->crud_model->get_type_name_by_id('general_settings','58','value') == 'ok'){}else
        { ?>style="display:none;"<?php } ?> >
            <div class="col-md-4 col-lg-4">
                <div class="panel panel-bordered panel-grad2" style="height:205px;">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Всего продавцов');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
                            <h1>
                ...
                <div class="panel panel-bordered panel-dark" style="height:205px;">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Ожидающие поставщики');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
                            <h1>
            ...
            <div class="col-md-8 col-lg-8">
                <div class="panel panel-bordered panel-grad">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo translate('Статистика поставщиков');?></h3>
                    </div>
                    <div class="panel-body">
                        <div class="text-center">
                            <div class="col-md-12 col-lg-12">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-bordered panel-purple">
                    <h3 class="panel-title" style="border-bottom:1px #9365b8 solid; !important;">
                        <?php echo translate('Ежемесячный запас по категориям');?>
                    </h3>
                    <div class="panel-body">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-bordered panel-black">
                    <h3 class="panel-title" style="border-bottom:1px #303641 solid; !important;">
                        <?php echo translate('Категория убытков');?>
                    </h3>
                    <div class="panel-body">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-bordered panel-success">
                    <h3 class="panel-title" style="border-bottom:1px #00a65a solid; !important;">
                        <?php echo translate('Ежемесячная распродажа по категории');?>
                    </h3>
                    <div class="panel-body">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-bordered panel-primary">
                    <h3 class="panel-title" style="border-bottom:1px #458fd2 solid; !important;">
                        <?php echo translate('Категория ежемесячной прибыли');?>
                    </h3>
                    <div class="panel-body">
...
<script>
	...
	var chartData3 = [
		<?php
		 ...
		 {
			 "country": "<?php echo $row['category_name']; ?>",
			 "visits": <?php echo $this->crud_model->month_total('stock', 'category', $row['category_id'], 'type', 'destroy', 
             'reason_note', "sale"); ?> ,
			 "color": "#303641"
		 }, 
		 <?php
	...
	var chartData4 = [
		<?php
			$categories = $this->db->get('category')->result_array();
			foreach($categories as $row) {
				$fin = ($this->crud_model->month_total('sale', 'category', $row['category_id'])) -
                 ($this->crud_model->month_total('stock', 'category', $row['category_id'], 'type', 'add'));
		?>
		{
			"country": "<?php echo $row['category_name']; ?>",
