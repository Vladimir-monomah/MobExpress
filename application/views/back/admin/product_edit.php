    ...
    <div class="col-md-12">
		...
		?>
            ...
            <div class="panel-heading">
                <div class="panel-control" style="float: left;">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#business_details"><?php echo translate('Детали бизнеса'); ?></a>
                        </li>
                        <li>
            ...
            <div class="panel-body">
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    placeholder="<?php echo translate('Название продукта');?>" class="form-control required">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    $row['category'],'digital',NULL,'get_cat'); ?>
                                </div>
                            </div>
                            <div class="form-group btm_border" id="sub" >
                                ...
                                <div class="col-sm-6" id="sub_cat">
                                    <?php echo $this->crud_model->select_html('sub_category','sub_category',
                                    'sub_category_name','edit','demo-chosen-select required',$row['sub_category'],'category',
                                    $row['category'],'get_brnd'); ?>
                                </div>
                            </div>
                            
                            <div class="form-group btm_border" id="brn" >
                                <label class="col-sm-4 control-label" for="demo-hor-4"><?php echo translate('Бренд');?></label>
                                <div class="col-sm-6" id="brand" >
                                    <?php 
                                        $brands=json_decode($this->crud_model->get_type_name_by_id('sub_category',
                                        $row['sub_category'],'brand'),true);
                                        if(count($brands)>0){
										  echo $this->crud_model->select_html('brand','brand','name','edit',
                                          'demo-chosen-select',$row['brand'],'brand_id',$brands,'','multi'); 
                                        }else{
                                            echo translate("В этой подкатегории нет брендов");
                                        }
									?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-5"><?php echo translate('Единица измерения');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    placeholder="<?php echo translate('Теги');?>" value="<?php echo $row['tag']; ?>" c
                                    lass="form-control">
                                </div>
                            </div>
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12">
                                <?php echo translate('Картинки');?></label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php 
                                        $images = $this->crud_model->file_view('product',
                                        $row['product_id'],'','','thumb','src','multi','all');
                                        if($images){
                                    ...
                                    ?>
                                        <div class="delete-div-wrap">
                                            ...
                                            <div class="inner-div">
                                                ...
                                                src="<?php echo $row1; ?>" data-id="<?php echo $i.'_'.$p; ?>" alt="User_Image" >
                                            </div>
                                        </div>
                                    <?php 
                                            }
                            ...
                            <div class="form-group btm_border">
                                ...
                                <?php echo translate('Напишите оптимизированный заголовок длиной не более 60 символов.')?></small></div>
                                <label class="col-sm-4 control-label" for="">
                                    <?php echo translate('Дружественный SEO заголовок');?>
                                </label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <label class="col-sm-4 control-label" for="">
                                    <?php echo translate('Дружественное SEO описание');?>
                                </label>
                                <div class="col-sm-6">
                                        <textarea name="seo_description"
                                                  placeholder=
                                                  "<?php echo translate('Ex. New Yamaha Sports bike in 2021 from Japan')?>"
                                                  class="form-control required" rows='4' >
                                                  <?php echo $row['seo_description']; ?></textarea>
                                </div>
                                <div class="col-sm-2"></div>
                            </div>
                            ...
                            ?> 
                                <div class="form-group btm_border">
                                    <div class="col-sm-4">
                                        <input type="text" name="ad_field_names[]" value="<?php echo $row1['name']; ?>" 
                                        placeholder="Field Name" class="form-control required" >
                                    </div>
                                    <div class="col-sm-5">
                                          <textarea rows="9"  class="summernotes" data-height="100" 
                                          data-name="ad_field_values[]"><?php echo $row1['value']; ?></textarea>
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                        <h4 class="pull-left">
                                            <i>
                                            <?php echo translate('если вам нужно больше поля для вашего продукта, нажмите здесь, чтобы узнать больше ...');?></i>
                                        </h4>
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-7"><?php echo translate('Цена');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="purchase_price" id="demo-hor-7" min='0' step='.01' 
                                    value="<?php echo $row['purchase_price']; ?>" placeholder="<?php echo translate('Цена');?>" 
                                    class="form-control required">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" name="shipping_cost" min='0' id="demo-hor-8" min='0' step='.01' 
                                    value="<?php echo $row['shipping_cost']; ?>" placeholder="<?php echo translate('Стоимость доставки');?>" 
                                    class="form-control">
                                </div>
                                <span class="btn"><?php echo currency('','def'); ?> / </span>
                                <span class="btn unit_set"><?php echo $row['unit']; ?></span>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-9"><?php echo translate('Налоги');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="tax" id="demo-hor-9" min='0' step='.01' value="<?php echo $row['tax']; ?>"
                                     placeholder="<?php echo translate('Налоги');?>" class="form-control">
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-10"><?php echo translate('Скидки');?></label>
                                <div class="col-sm-4">
                        ...
                        <div id="customer_choice_options" class="tab-pane fade">
                            ...
                            <div class="form-group btm_border">'
                                <label class="col-sm-4 control-label" for="demo-hor-15">
                                    <?php echo translate('Варианты цвета продукта');?>
                                        </label>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                        <div id="more_color_btn" class="btn btn-primary btn-labeled fa fa-plus pull-right">
                                            <?php echo translate('Добавить цвет');?></div>
                                </div>
                            </div>
                            ...
                            ?> 
                                <div class="form-group" data-no="<?php echo $row1['no']; ?>">
                                    <div class="col-sm-4">
                                        <input type="text" name="op_title[]" value="<?php echo $row1['title']; ?>" 
                                        class="form-control required"  placeholder="<?php echo translate('Заголовок ввода клиента'); ?>">
                                    </div>
                                    <div class="col-sm-5">
                                        <select class="demo-chosen-select op_type required" name="op_type[]" >
                                            <option value="" <?php if($row1['type'] == ''){ echo 'selected'; } ?> >(Нету)</option>
                                            <option value="text" <?php if($row1['type'] == 'text'){ echo 'selected'; } ?> >Текст ввода</option>
                                            <option value="single_select" <?php if($row1['type'] == 'single_select'){ echo 'selected'; } ?> >
                                            Выпадающий одиночный выбор</option>
                                            <option value="radio" <?php if($row1['type'] == 'radio'){ echo 'selected'; } ?> >Кнопка</option>
                                        </select>
                                        ...
                                        ?>
                                            <div class="col-sm-12">
                                                ...
                                                <?php foreach ($row1['option'] as $key => $row2) { ?>
                                                    <div>
                                                        <div class="col-sm-10">
                                                          <input type="text" name="op_set<?php echo $row1['no']; ?>[]" value="<?php echo $row2; ?>" 
                                                          class="form-control required"  placeholder="<?php echo translate('Название опции'); ?>">
                                                        </div>
                                                        <div class="col-sm-2">
                                                          <span class="remove_it_n rmon btn btn-danger btn-icon btn-circle icon-sm fa fa-times" 
                                    ...
                                    <div class="col-sm-2">
                                        <span class="remove_it_o rmo btn btn-danger btn-icon btn-circle icon-lg fa fa-times" 
                                        onclick="delete_row(this)"></span>
                                    </div>
                                </div>
                            <?php
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <h4 class="pull-left">
                                        <i><?php 
                                        echo translate('если вам нужны дополнительные варианты выбора для покупателей этого продукта, нажмите здесь.');?></i>
                                    </h4>
                ...
                <?php echo translate('Следующий'); ?></span>
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('edit','<?php echo translate('Редактировать продукт'); ?>',
                            '<?php echo translate('Успешно отредактирован!'); ?>','product_edit','
                            <?php echo $row['product_id']; ?>') "><?php echo translate('Перезагрузить');?>
                        </span>
                     </div>
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" 
                         onclick="form_submit('product_edit','<?php echo translate('Успешно отредактирован!'); ?>');
                         proceed('to_add');" ><?php echo translate('Редактировать');?></span> 
                     </div>
                </div>
            </div>
        </form>
