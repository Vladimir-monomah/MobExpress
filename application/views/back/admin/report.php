...
<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow" ><?php echo translate('Сравнение продаж товаров');?></h1>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-pane fade active in"  id="" >
                    <div class="panel panel-bordered-primary">
                    	<div class="panel-heading">
                            ...
                            <?php echo translate('Отчет о сравнении продаж товаров');?>
                            </h3>
						</div>
                        <div class="panel-body">
...
<script>
	...
	function generateChartData() {
		...
		?>
					...
					var value 		= <?php echo $this->crud_model->sale_details_by_product_date
					($row['product_id'],$row1,'subtotal'); ?>;
					var volume 		= <?php echo $this->crud_model->sale_details_by_product_date
					($row['product_id'],$row1,'qty'); ?>;
