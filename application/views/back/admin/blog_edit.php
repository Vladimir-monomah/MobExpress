                        ...
                        <div id="blog_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1">
                                    <?php echo translate('Название блога');?>
                                        </label>
                                <div class="col-sm-6">
                                    <input type="text" name="title" id="demo-hor-1" value="<?php echo $row['title']; ?>" 
                                    placeholder="<?php echo translate('Название блога');?>" class="form-control required">
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <?php echo $this->crud_model->select_html('blog_category','blog_category','name','edit',
                                    'demo-chosen-select required',$row['blog_category'],'','','get_cat'); ?>
                                </div>
                            </div>
                            
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-12"><?php echo translate('Картинка');?></label>
                                <div class="col-sm-6">
                                    <span class="pull-left btn btn-default btn-file"> <?php echo translate('Выбрать файл');?>
                                        <input type="file" name="img" onchange="preview(this);" id="demo-hor-inputpass" 
                                        class="form-control">
                                    </span>
                                    <br><br>
                                    <span id="previewImg" >
                                        <img class="img-responsive" width="100" src="<?php echo $this->crud_model->
                                        file_view('blog',$row['blog_id'],'','','thumb','src','',''); ?>" alt="User_Image" >
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-14">
                                    <?php echo translate('Резюме');?>
                                        </label>
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="200" data-name="summery">
                                    <?php echo $row['summery']; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    <textarea rows="9" class="summernotes" data-height="300" data-name="description">
                                    <?php echo $row['description']; ?></textarea>
                                </div>
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Автор');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author" value="<?php echo $row['author']; ?>"
                                     id="demo-hor-1" placeholder="<?php echo translate('Автор');?>" class="form-control ">
                                </div>
                            </div>

                            <div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-1"><?php echo translate('Дата');?></label>
                                <div class="col-sm-6">
                                    <input type="date" name="date" value="<?php echo $row['date']; ?>" id="demo-hor-1" 
                                    class="form-control">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-11">
                    	<span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right" 
                            onclick="ajax_set_full('edit','<?php echo translate('Редактировать блог'); ?>',
                            '<?php echo translate('Успешно отредактирован!'); ?>','blog_edit',
                            '<?php echo $row['blog_id']; ?>') "><?php echo translate('Обновить');?>
                        </span>
                     </div>
                     <div class="col-md-1">
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" 
                         onclick="form_submit('blog_edit','<?php echo translate('Успешно отредактирован!'); ?>');
                         proceed('to_add');" ><?php echo translate('Изменить');?></span> 
                     </div>
                </div>
            </div>
        </form>
