...
<div id="content-container">
	<div id="page-title">
		<h1 class="page-header text-overflow"><?php echo translate('Отчет о желании продукта');?></h1>
	</div>
    <div class="tab-base">
        <div class="panel">
...
<script>
	...
	zoomChart();
	function zoomChart() {
		chart.zoomToIndexes(chart.dataProvider.length - <?php echo $total; ?>, chart.dataProvider.length - 
		<?php echo $total-20; ?>);
	}
