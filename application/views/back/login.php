...
<body>
		...
		<div class="cls-content">
			<div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 50px !important;">
				<div class="panel-body">
                    ...
                    <hr class="hr-log">
					<p class="pad-btm"><?php echo translate('Войдите в свой аккаунт');?></p>
					<?php
					...
					?>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="password" name="password" class="form-control pass" placeholder="<?php echo translate('Пароль'); ?>">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-6 text-left">
                            	<div class="pad-ver">
                                    <a href="#" onclick="ajax_modal('forget_form','<?php echo translate('Забыли пароль?'); ?>',
                                    '<?php echo translate('Письмо с новым паролем отправлено на Email'); ?>','forget','')" 
                                    class="btn-link mar-rgt" style="color:#fff !important;"><?php echo translate('Забыл пароль');?> ?</a>
                                </div>
							</div>
							<div class="col-xs-6">
	...
	<script>
        ...
        var cancdd = "<?php echo translate('отменён'); ?>";
        var req = "<?php echo translate('Это поле обязательно к заполнению'); ?>";
		var sing = "<?php echo translate('вход в систему ...'); ?>";
		var nps = "<?php echo translate('новый пароль отправлен на электронную почту'); ?>";
		var lfil = "<?php echo translate('Ошибка входа!'); ?>";
		var wrem = "<?php echo translate('не правильный адрес почты! Попробуйте ещё раз'); ?>";
		var lss = "<?php echo translate('Авторизация успешна!'); ?>";
		var sucss = "<?php echo translate('УСПЕХ!'); ?>";
		var rpss = "<?php echo translate('Сброс пароля'); ?>";
        var user_type = "<?php echo $control; ?>";
        var module = "login";
		var unapproved = "<?php echo translate('Аккаунт не одобрен! Ожидайте подтверждения'); ?>";
